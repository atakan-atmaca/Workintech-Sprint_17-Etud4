public interface OgrenciRepository extends JpaRepository<Ogrenci, Long> {
    ...
    String QUESTION_2 = "SELECT * FROM ogrenci WHERE cinsiyet='Kız'";
    ...
    String QUESTION_4 = "SELECT * FROM ogrenci WHERE sinif='10A' AND cinsiyet='Kız'";
    @Query(value = QUESTION_4, nativeQuery = true)
    List<Ogrenci> find10AGirls();

    // 5- Öğrenci numarası 5 ile 10 arasında olan kız öğrencileri listeleyiniz.
    String QUESTION_5 = "SELECT * FROM ogrenci WHERE cinsiyet='Kız' AND ogrno BETWEEN 5 AND 10";
